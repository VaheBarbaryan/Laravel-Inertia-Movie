                    ...
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <form class="flex space-x-4 shadow bg-white rounded-md m-2 p-2">
                            <div class="p-1 flex items-center">
                                <label for="tmdb_id_g" class="block text-sm font-medium text-gray-700 mr-4">TvShow Tmdb
                                    Id</label>
                                ...
                                <TableRow v-for="tvShow in tvShows.data" :key="tvShow.id">
                                    ...
                                    <TableData style="text-align: center">
                                        <img class="h-24 w-24 rounded inline"
                                             :src=" tvShow.poster_path ? `https://www.themoviedb.org/t/p/w220_and_h330_face/${tvShow.poster_path}` : ''"
                                             alt="Poster">
                                    </TableData>
                                    ...
                                    <TableData style="text-align: center;">
                                        ...
                                        <ButtonLink class="bg-red-500 hover:bg-red-700" method="delete" as="button"
                                                    type="button" :link="route('admin.tv-shows.destroy',tvShow.id)">
                                            Delete
                                        </ButtonLink>
                                    </TableData>
                                </TableRow>
