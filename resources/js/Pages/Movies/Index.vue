                    ...
                    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg bg-white">
                        <div>
                            <div class="flex justify-between p-5">
                                ...
                                <div class="flex">
                                    <select v-model="perPage" @change="getMovies"
                            ...
                            <Table>
                                <template #tableHead>
                                    <TableHead class="cursor-pointer" @click="sort('title')">
                                        <div class="flex">
                                            <span>Title</span>
                                            <svg v-if="column == 'title' && direction == 'DESC'"
                                            ...
                                            <svg v-if="column == 'title' && direction == 'ASC'"
                                                 xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700"
                                                 fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <TableHead class="cursor-pointer" @click="sort('rating')">
                                        <div class="flex">
                                            <span>Rating</span>
                                            <svg v-if="column == 'rating' && direction == 'DESC'"
                                                 xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700"
                                                 fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <svg v-if="column == 'rating' && direction == 'ASC'"
                                                 xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700"
                                                 fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <TableHead class="cursor-pointer" @click="sort('visits')">
                                        <div class="flex">
                                            <span>Visits</span>
                                            <svg v-if="column == 'visits' && direction == 'DESC'"
                                                 xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700"
                                                 fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            <svg v-if="column == 'visits' && direction == 'ASC'"
                                                 xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-700"
                                                 fill="none"
                                                 viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <TableRow v-for="movie in movies.data" :key="movie.id">
                                    ...
                                    <TableData style="text-align: center">
                                        <img class="h-24 w-24 rounded inline"
                                             :src="movie.poster_path ? `https://www.themoviedb.org/t/p/w220_and_h330_face/${movie.poster_path}` : ''"
                                             alt="Poster">
                                    </TableData>
                                    <TableData>
                                    ...
                                    <TableData>
                                        ...
                                        <ButtonLink class="bg-red-500 hover:bg-red-700" method="delete" as="button"
                                                    type="button" :link="route('admin.movies.destroy',movie.id)">
                                            Delete
                                        </ButtonLink>
                                    </TableData>
                                </TableRow>
...
<script setup>
    ...
    const column = ref(props.column ? props.column : 'id');
    const direction = ref(props.direction ? props.direction : 'DESC');
