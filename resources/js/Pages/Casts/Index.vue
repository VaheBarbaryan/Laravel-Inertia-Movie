                            ...
                            <Table>
                                ...
                                <TableRow v-for="cast in casts.data" :key="cast.id">
                                    ...
                                    <TableData style="text-align: center;">
                                        <img class="h-32 w-24 rounded inline"
                                             :src="`https://www.themoviedb.org/t/p/w300_and_h450_bestv2/${cast.poster_path}`" alt="poster">
                                    </TableData>
                                    <TableData>
                                        ...
                                        <ButtonLink class="bg-red-500 hover:bg-red-700" method="delete" as="button"
                                                    type="button" :link="route('admin.casts.destroy',cast.id)">
                                            Delete
                                        </ButtonLink>
                                    </TableData>
                                </TableRow>
